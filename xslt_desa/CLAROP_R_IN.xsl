...
<?oracle-xsl-mapper
  ...
  <mapSources>
    <source type="WSDL">
      ...
      <rootElement name="entradaEjecutarReverso" namespace="http://www.bolivariano.com/mensaje/MensajeOTC"/>
    </source>
  </mapSources>
  <mapTargets>
    <target type="WSDL">
      ...
      <rootElement name="MensajeEntradaReversarClaroPostPago" namespace="http://www.bolivariano.com/MensajeClaro"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.7.0(build 130301.0647.0008) AT [MON MAY 21 18:03:17 COT 2018]. -->
?>
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/">
		<mcl:MensajeEntradaReversarClaroPostPago>
			<canal>
				<xsl:value-of select="/tns:entradaEjecutarReverso/ns8:canal"/>
			</canal>
			<fecha>
			...
			<transaccion>
				<xsl:text disable-output-escaping="no">62531</xsl:text>
			</transaccion>
			<usuario>
			...
			<informacionClaro>
				...
				<!--<xsl:if test="/tns:entradaEjecutarReverso/ns8:canal='BIB'">-->
				<canalCobranza>
			...
			<xsl:choose>
					<xsl:when test="/tns:entradaEjecutarReverso/ns8:canal = 'CNB' and (/ns8:entradaEjecutarReverso/ns8:datosAdicionales/ns8:datoAdicional[codigo = 'p_forma_pago']/valor = 'EFE')">
						<efectivo>
					...
					<xsl:when test="/tns:entradaEjecutarReverso/ns8:canal = 'CNB' and (/ns8:entradaEjecutarReverso/ns8:datosAdicionales/ns8:datoAdicional[codigo = 'p_forma_pago']/valor = 'DEB')">
						<debito>
							<xsl:value-of select="format-number(/tns:entradaEjecutarReverso/ns8:valorPago, '0.00')"/>
						</debito>
						<debitoComision>
					...
					<xsl:otherwise>
						...
						<efectivoComision>
							<xsl:text disable-output-escaping="no">0.00</xsl:text>
                              ...
                              <xsl:choose>
					<xsl:when test="/tns:entradaEjecutarReverso/ns8:canal = 'CNB'">
						<empresa>
					...
					<xsl:otherwise>
						<empresa>
					           <xsl:value-of select='/ns8:entradaEjecutarReverso/ns8:datosAdicionales/ns8:datoAdicional[codigo = "codigoEmpresa"]/valor'/>
			                	</empresa>
					</xsl:otherwise>
				</xsl:choose>
				
				<fechaContable>
					<xsl:value-of select='substring(/ns8:entradaEjecutarReverso/ns8:datosAdicionales/ns8:datoAdicional[codigo = "s_date"]/valor, 1, 10)'/>
				</fechaContable>
				<nombre>
					<xsl:value-of select="/tns:entradaEjecutarReverso/ns8:nombreCliente"/>
				</nombre>
				<tipoMoneda>
				...
				<cuenta>
					<cuenta>
						<xsl:value-of select="/tns:entradaEjecutarReverso/ns8:cuenta"/>
					</cuenta>
					<xsl:choose>		
						<xsl:when test="/tns:entradaEjecutarReverso/ns8:canal = 'CNB' and (/ns8:entradaEjecutarReverso/ns8:datosAdicionales/ns8:datoAdicional[codigo = 'p_forma_pago']/valor = 'EFE')">
							<tipoCuenta>
						...
						<xsl:otherwise>
							<tipoCuenta>
								<xsl:value-of select="/tns:entradaEjecutarReverso/ns8:tipoCuenta"/>
							</tipoCuenta>
						</xsl:otherwise>
					</xsl:choose>
				...
				<celular>
					<xsl:value-of select="/tns:entradaEjecutarReverso/ns8:servicio/identificador"/>
				</celular>
				<codigoInstitucion>
			...
			<informacionCore>
				<login>
					<xsl:text disable-output-escaping="no">28145</xsl:text>
				</login>
				<modoCorreccion>
				...
				<xsl:choose>
				    <xsl:when test="/tns:entradaEjecutarReverso/ns8:canal = 'CNB'">
				    	<reversoTransaccion>
					<xsl:value-of select='substring(/ns8:entradaEjecutarReverso/ns8:datosAdicionales/ns8:datoAdicional[codigo = "p_reversoTransaccion"]/valor, 1, 10)'/>
				</reversoTransaccion>
				    </xsl:when>
				    <xsl:otherwise>
				    		<reversoTransaccion>
					<xsl:value-of select='substring(/ns8:entradaEjecutarReverso/ns8:datosAdicionales/ns8:datoAdicional[codigo = "s_ssn_reverse"]/valor, 1, 10)'/>
				</reversoTransaccion>
				    </xsl:otherwise>	  
			    </xsl:choose>
				...
				<secuencial>
					<xsl:value-of select='substring(/ns8:entradaEjecutarReverso/ns8:datosAdicionales/ns8:datoAdicional[codigo = "s_ssn"]/valor, 1, 10)'/>
				</secuencial>
				<servidor>
