...
<?oracle-xsl-mapper
  ...
  <mapSources>
    <source type="WSDL">
      ...
      <rootElement name="MensajeSalidaConsultar" namespace="http://www.bolivariano.com/MensajeDirecTV"/>
    </source>
  </mapSources>
  <mapTargets>
    <target type="WSDL">
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.7.0(build 130301.0647.0008) AT [MON MAY 28 10:53:51 COT 2018]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                exclude-result-prefixes="xsi xsl xsd1 tns soap ns1 ns3 wsdl ns6 ns0 ns4 xsd ns2 ns5 ns7 ns13 ns14 ns17 ns18 ns9 ns10 ns11 ns12 ns8 ns15 ns16 xp20 bpws bpel bpm ora socket mhdr oraext dvm hwf med ids xdk xref ldap">
  <xsl:template match="/">
    <ns8:salidaConsultarDeuda>
      <xsl:if test='/xsd1:MensajeSalidaConsultar/codigoError = "01"'>
        <ns16:codigoError>
