...
<?oracle-xsl-mapper
  ...
  <mapSources>
    <source type="WSDL">
      ...
      <rootElement name="MensajeSalidaPagar" namespace="http://www.bolivariano.com/MensajeBelcorp"/>
    </source>
  </mapSources>
  <mapTargets>
    <target type="WSDL">
...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    <ns15:salidaEjecutarPago>
      <xsl:choose>
        <xsl:when test="/xsd1:MensajeSalidaPagar/codigoError='000'">
  ...
  <xsl:template name="RespuestaOK">
      ...
      <ns15:fechaPago>
        <xsl:value-of select="/xsd1:MensajeSalidaPagar/informacionBelcorp/fechaContable"/>
      </ns15:fechaPago>
      <ns15:mensajeUsuario>
        <xsl:value-of select="/xsd1:MensajeSalidaPagar/mensajeUsuario"/>
      </ns15:mensajeUsuario>
      ...
      <ns15:referencia>
        <xsl:value-of select="/xsd1:MensajeSalidaPagar/informacionBelcorp/trace"/>
      </ns15:referencia>
      <ns15:datosAdicionales>        
        <ns15:datoAdicional>
          ...
          <valor>
            <xsl:value-of select="/xsd1:MensajeSalidaPagar/informacionBelcorp/horario"/>
          </valor>
        </ns15:datoAdicional>
      </ns15:datosAdicionales>
  </xsl:template>
