	...
	<xsl:template match="/">
		<CTSMessage>
			<CTSHeader>
				...
				<Field name="t_rol" type="N"><xsl:value-of select='/men:entradaEjecutarPago/men:datosAdicionales/men:datoAdicional[codigo = "s_rol"]/valor'/></Field>
			</CTSHeader>
			<Data>
				<ProcedureRequest>
					<SpName>cob_procesador..fp_pago_ecutel</SpName>
					<Param name="@s_user" type="47" io="0" len="6"><xsl:value-of select='/men:entradaEjecutarPago/men:datosAdicionales/men:datoAdicional[codigo = "s_user"]/valor'/></Param>
					...
					<Param name="@i_ubi" type="52" io="0" len="2"><xsl:value-of select='/men:entradaEjecutarPago/men:datosAdicionales/men:datoAdicional[codigo = "i_ubi"]/valor'/></Param>
