...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  <mapSources>
    <source type="WSDL">
      ...
      <rootElement name="MensajeSalidaObtenerSaldoPendiente" namespace="http://www.bolivariano.com/CashManagement/MensajesEcuaquimica"/>
    </source>
  </mapSources>
  <mapTargets>
    <target type="WSDL">
...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/">
		<ns17:salidaConsultarDeuda>
			<xsl:choose>
				<xsl:when test="/mcnel:MensajeSalidaObtenerSaldoPendiente/codigoError='0'">
	...
	<xsl:template name="RespuestaOK">
		<ns17:codigoError>
			<xsl:value-of select="/mcnel:MensajeSalidaObtenerSaldoPendiente/codigoError"/>
		</ns17:codigoError>
		<ns17:montoTotal>
			<xsl:value-of select="/mcnel:MensajeSalidaObtenerSaldoPendiente/deuda"/>
		</ns17:montoTotal>
		<ns17:mensajeUsuario>
			<xsl:value-of select="/mcnel:MensajeSalidaObtenerSaldoPendiente/estado"/>
		</ns17:mensajeUsuario>
		<ns17:formaPago>
			<xsl:text disable-output-escaping="no">ABONO</xsl:text>
		</ns17:formaPago>
		<ns17:nombreCliente>
			<xsl:value-of select="/mcnel:MensajeSalidaObtenerSaldoPendiente/nombreCliente"/>
		</ns17:nombreCliente>
	</xsl:template>
	<xsl:template name="RespuestaError">
		...
		<ns17:mensajeUsuario>
			<xsl:value-of select="/mcnel:MensajeSalidaObtenerSaldoPendiente/mensajeUsuario"/>
		</ns17:mensajeUsuario>
	</xsl:template>
</xsl:stylesheet>
