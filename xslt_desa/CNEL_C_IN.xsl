...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  ...
  <mapTargets>
    ...
    <target type="WSDL">
      ...
      <rootElement name="MensajeEntradaConsultar" namespace="http://www.bolivariano.com/MensajeCNEL"/>
...
<xsl:stylesheet version="1.0"
                ...
                exclude-result-prefixes="xsi xsl ns1 soap wsdl ns5 ns6 ns9 ns10 ns0 ns2 ns3 ns4 tns xsd ns7 ns8 ns11 ns12 ns14 ns16 ns13 ns17 mcnel http ns15 ns18 ns19 xp20 bpws bpel bpm ora socket mhdr oraext dvm hwf med ids xdk xref ldap">
  ...
  <xsl:template match="/">
    ...
    <mcnel:MensajeEntradaConsultar>
      ...
      <transaccion>
        ...
        <xsl:text disable-output-escaping="no">62273</xsl:text>
      ...
      <electrica>
				...
				<xsl:choose>
					<xsl:when test="/ns8:entradaConsultarDeuda/ns8:canal = 'CNB'">
						<canalCobranza>
							<xsl:text disable-output-escaping="no">CNB</xsl:text>
						</canalCobranza>
					</xsl:when>
					<xsl:otherwise>
						<canalCobranza>
        ...
        <codigoAdquiriente>007</codigoAdquiriente>

        <codigoAutorizador>

          <xsl:choose>

            <xsl:when test="/ns8:entradaConsultarDeuda/ns8:servicio/codigoConvenio=4977">

              <xsl:text disable-output-escaping="no">201</xsl:text>

            </xsl:when>

            <xsl:when test="/ns8:entradaConsultarDeuda/ns8:servicio/codigoConvenio=825">

              <xsl:text disable-output-escaping="no">301</xsl:text>

            </xsl:when>

            <xsl:when test="/ns8:entradaConsultarDeuda/ns8:servicio/codigoConvenio=331">

              <xsl:text disable-output-escaping="no">901</xsl:text>

            </xsl:when>

            <xsl:when test="/ns8:entradaConsultarDeuda/ns8:servicio/codigoConvenio=1127">

              <xsl:text disable-output-escaping="no">101</xsl:text>

            </xsl:when>

            <xsl:when test="/ns8:entradaConsultarDeuda/ns8:servicio/codigoConvenio=1330">

              <xsl:text disable-output-escaping="no">601</xsl:text>

            </xsl:when>

            <xsl:when test="/ns8:entradaConsultarDeuda/ns8:servicio/codigoConvenio=1719">

              <xsl:text disable-output-escaping="no">401</xsl:text>

            </xsl:when>

            <xsl:when test="/ns8:entradaConsultarDeuda/ns8:servicio/codigoConvenio=4978">

              <xsl:text disable-output-escaping="no">501</xsl:text>

            </xsl:when>

            <xsl:when test="/ns8:entradaConsultarDeuda/ns8:servicio/codigoConvenio=4979">

              <xsl:text disable-output-escaping="no">701</xsl:text>

            </xsl:when>

            <xsl:when test="/ns8:entradaConsultarDeuda/ns8:servicio/codigoConvenio=4980">

              <xsl:text disable-output-escaping="no">801</xsl:text>

            </xsl:when>

            <xsl:when test="/ns8:entradaConsultarDeuda/ns8:servicio/codigoConvenio=4981">
        ...
        <codigoOperador>000998</codigoOperador>

        <codigoSeguridad>007224605</codigoSeguridad>
        ...
        <codigoTerminal>0007000000000998</codigoTerminal>
        ...
        <monedaProveedor>840</monedaProveedor>

        <secuencialAdquiriente>000000</secuencialAdquiriente>

        <servicioProveedor>001</servicioProveedor>

        <tipoTransaccion>000100</tipoTransaccion>
