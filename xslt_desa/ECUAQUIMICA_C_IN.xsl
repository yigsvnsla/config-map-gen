...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  ...
  <mapTargets>
    <target type="WSDL">
      ...
      <rootElement name="MensajeEntradaObtenerSaldoPendiente" namespace="http://www.bolivariano.com/CashManagement/MensajesEcuaquimica"/>
    </target>
  </mapTargets>
...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/">
		<mcnel:MensajeEntradaObtenerSaldoPendiente>
			<canal>
			...
			<transaccion>
				<xsl:text disable-output-escaping="no">62670</xsl:text>
			</transaccion>
			<usuario>
			...
			<tipoIdentificacion>
				<xsl:choose>
					...
					<xsl:when test="/ns8:entradaConsultarDeuda/ns8:servicio/codigoTipoIdentificador='RUC'">
						<xsl:text disable-output-escaping="no">C</xsl:text>
					</xsl:when>
					<xsl:otherwise>
