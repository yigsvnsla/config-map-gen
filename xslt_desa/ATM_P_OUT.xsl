...
<?oracle-xsl-mapper <!-- SPECIFICATION OF MAP SOURCES AND TARGETS, DO NOT MODIFY. -->
  <mapSources>
    <source type="WSDL">
      ...
      <rootElement name="MensajeSalidaPago" namespace="http://www.bolivariano.com/MensajeEMT"/>
    </source>
  </mapSources>
  <mapTargets>
    <target type="WSDL">
...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    <ns16:salidaEjecutarPago>
      <xsl:if test='/xsd1:MensajeSalidaPago/codigoErrorRemoto != "T0000"'>
        <ns16:codigoError>
      ...
      <xsl:if test='/xsd1:MensajeSalidaPago/codigoErrorRemoto = "T0000"'>
        <ns16:datosAdicionales>
          <ns16:datoAdicional>
            ...
            <valor>
              <xsl:value-of select="/xsd1:MensajeSalidaPago/emt/secuenciaRecibo"/>
            </valor>
            <visible>
              <xsl:text disable-output-escaping="no">false</xsl:text>
            </visible>
          ...
          <ns16:datoAdicional>
            ...
            <valor>
              <xsl:value-of select="/xsd1:MensajeSalidaPago/emt/horario"/>
            </valor>
          </ns16:datoAdicional>
        </ns16:datosAdicionales>
        ...
        <ns16:fechaPago>
          <xsl:value-of select="/xsd1:MensajeSalidaPago/emt/fechaContable"/>
        </ns16:fechaPago>
        <ns16:fechaDebito>
