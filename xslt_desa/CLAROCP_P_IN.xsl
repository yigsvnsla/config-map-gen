...
<xsl:stylesheet version="1.0"
                ...
                exclude-result-prefixes="xsi xsl ns1 soap wsdl ns5 ns6 ns9 ns10 ns0 ns2 ns3 ns4 xsd ns7 ns8 WL5G3N4 ns12 ns14 mime cta ns11 ns15 mcl clr ns13 ns16 xp20 bpws bpel bpm ora socket mhdr oraext dvm hwf med ids xdk xref ldap">
	<xsl:template match="/">
		<mcl:MensajeEntradaRecargarPaquetes>
			...
			<proceso>
				<xsl:text disable-output-escaping="no">132</xsl:text>
			</proceso>
			...
			<transaccion>
				<xsl:text disable-output-escaping="no">62672</xsl:text>
			</transaccion>
			...
			<codigoEmpresa>
				<xsl:text disable-output-escaping="no">40</xsl:text>
			</codigoEmpresa>
			...
			<consumidorID>
				<xsl:text disable-output-escaping="no">BOLIVARIANO_001</xsl:text>
			</consumidorID>
			...
			<autorizacionProv>
				<xsl:text disable-output-escaping="no">RECARGA_DATOS</xsl:text>
			</autorizacionProv>

			<codigoMensaje>
				<xsl:text disable-output-escaping="no">10.30.9.141</xsl:text>
			</codigoMensaje>
