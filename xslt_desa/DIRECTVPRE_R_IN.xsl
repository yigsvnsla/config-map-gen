...
<?oracle-xsl-mapper
  ...
  <mapTargets>
    <target type="WSDL">
      ...
      <rootElement name="MensajeEntradaReverso" namespace="http://www.bolivariano.com/MensajeDirecTV"/>
    </target>
  </mapTargets>
  ...
  <xsl:template match="/">
    <xsd1:MensajeEntradaReverso>
      ...
      <directv>
        ...
        <autorizacion>
		  <xsl:value-of select="/ns8:entradaEjecutarReverso/ns8:datosAdicionales/ns8:datoAdicional[codigo = 'p_autorizacion']/valor"/>
        </autorizacion>
        <cantidadCheque>
        ...
        <xsl:choose>
			 <xsl:when test="/tns:entradaEjecutarReverso/ns8:canal = 'CNB'" >
			   <empresa>
				<xsl:value-of select='/tns:entradaEjecutarReverso/ns8:datosAdicionales/ns8:datoAdicional[codigo = "p_codigoEmpresa"]/valor'/>
			   </empresa>
			   <tipoMoneda>
			 ...
			 <xsl:otherwise>
			   <empresa>
				<xsl:value-of select="/tns:entradaEjecutarReverso/ns8:servicio/codigoEmpresa"/>
			   </empresa>
			 </xsl:otherwise>
		  </xsl:choose>    
        <totalComision>
        ...
        <valorTotalCancelar>
          <xsl:value-of select="/tns:entradaEjecutarReverso/ns8:valorPago + /tns:entradaEjecutarReverso/ns8:valorComision"/>
        </valorTotalCancelar>
        <cuenta>
          <cuenta>
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				<codigo>          
					<xsl:value-of select="concat(substring(/tns:entradaEjecutarReverso/ns8:servicio/identificador, 1, 4),substring(/tns:entradaEjecutarReverso/ns8:servicio/identificador, 6, 4),substring(/tns:entradaEjecutarReverso/ns8:servicio/identificador, 11, 4))"/>
				</codigo>
			</xsl:otherwise>
		</xsl:choose>
		...
		<nombreSuscriptor>
			<xsl:value-of select="/ns8:entradaEjecutarReverso/ns8:datosAdicionales/ns8:datoAdicional[codigo = 'p_nombreSuscriptor']/valor"/>
		</nombreSuscriptor>
        <secuenciaTerminal>
	...
	<xsl:choose>
		...
		<sec>
		  <xsl:text disable-output-escaping="no">55</xsl:text>
		</sec>
        <secuencial>
