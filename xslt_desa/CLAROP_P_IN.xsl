...
<?oracle-xsl-mapper
  ...
  <mapTargets>
    <target type="WSDL">
      ...
      <rootElement name="MensajeEntradaPagarClaroPostPago" namespace="http://www.bolivariano.com/MensajeClaro"/>
    </target>
  </mapTargets>
...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/">
		<mcl:MensajeEntradaPagarClaroPostPago>
			<canal>
			...
			<informacionClaro>
				...
				<fechaContable>
					<xsl:value-of select='substring(/ns8:entradaEjecutarPago/ns8:datosAdicionales/ns8:datoAdicional[codigo = "s_date"]/valor, 1, 10)'/>
				</fechaContable>
				<nombre>
					<xsl:value-of select="/tns:entradaEjecutarPago/ns8:nombreCliente"/>
				</nombre>
				<tipoMoneda>
			...
			<informacionCore>
				...
				<secuencial>
					<xsl:value-of select='substring(/ns8:entradaEjecutarPago/ns8:datosAdicionales/ns8:datoAdicional[codigo = "s_ssn"]/valor, 1, 10)'/>
				</secuencial>
				<servidor>
